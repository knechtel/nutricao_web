...
4) Update Dependencies: Right click on the project > Maven > Update Project.

5) Configure web server: right click on the Project, select Run AS > Run on Server. Choose WildFly11 > Next
...
5.1) Set the path for your WildFliy and make the download on the link just like the picture below shows. Enter the Home Directoryand click on "Download and Install runtime".
...
6) On a broswser, access http://localhost:8080/nutricao_web
